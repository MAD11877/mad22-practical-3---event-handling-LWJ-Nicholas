...
2. Create a sg.edu.np.mad.s10222425_practical_2.MainActivity.User class based on the class diagram below.

![sg.edu.np.mad.s10222425_practical_2.MainActivity.User Class Diagram](/images/user_cd.png)

3. Create the layout of your main activity according to the figure shown below.

![Screen Mockup](/images/screen_mock.png)

4. In your onCreate method, the name and description are loaded from the sg.edu.np.mad.s10222425_practical_2.MainActivity.User object. The button on the left will show “Follow” if the variable followed is false, and vice versa.
